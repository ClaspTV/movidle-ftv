...
data class Player(var userName: String, val userId: String, var score: String = "0", var userAvatar: String) {
    fun getJson(): JSONObject {
        return JSONObject().apply {
            ...
            put(VizbeeXMessageParameter.USER_AVATAR.value, userAvatar)
        }
    }
